...
const addDonation = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!campaign) {
            throw new utils_1.CustomedError('Cannot add donation, campaign not exists', 400);
        }
        yield validation_1.donationSchema.validateAsync(req.body);
        if (!food && !clothes && !money) {
            next(new utils_1.CustomedError('You should enter money, piece of clothes, number of meals', 400));
        }
