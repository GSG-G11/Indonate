...
const updateCampaign = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const campaignData = yield utils_1.campaignSchema.validateAsync(req.body);
        const result = yield models_1.Campaign.update(campaignData, {
            where: { id },
        });
        if (!result[0]) {
            throw new utils_1.CustomError('Fail to update', 400);
        }
...
exports.default = updateCampaign;
