...
const login = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!user) {
            throw new utils_1.CustomedError("Email doesn't exists, Try another one or sign up", 400);
        }
        const isPasswordValidate = yield (0, bcryptjs_1.compare)(password, user === null || user === void 0 ? void 0 : user.getDataValue('password'));
        if (!isPasswordValidate) {
            throw new utils_1.CustomedError('Incorrect password, please try again', 400);
        }
        const payload = {
