...
const contactModule = __importStar(require("./contacts.json"));
...
const buildFakeData = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Promise.all([
        campaigns.map((campaign) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        messages.map((message) => __awaiter(void 0, void 0, void 0, function* () {
            yield models_1.Contact.create(message);
        })),
