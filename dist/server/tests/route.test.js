...
const campaigns = __importStar(require("./getAllCampaignsResult.json"));
...
describe('GET /statistics', () => {
    test('get all stats', () => __awaiter(void 0, void 0, void 0, function* () {
        const { body: { data }, } = yield (0, supertest_1.default)(app_1.default).get('/api/statistics').expect(200);
        expect(data).toEqual({
            FAMILIES: 5,
            MONEY: '1000',
            FOODS: '101',
...
describe('GET/checkAuth', () => {
    ...
    test('unAuthorized uer ', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('test in there is not ACCESS_TOKEN ', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(app_1.default).get('/api/checkAuth').set('Cookie', []).expect(401);
    }));
});
describe('GET /campaigns', () => {
    test('get all campaigns', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default).get('/api/campaigns').expect(200);
        expect(response.body.data.campaigns[0]).toEqual(campaigns[0]);
    }));
    test('test pagination get the three campaigns page 1', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default).get('/api/campaigns?page=1&limit=3', () => {
    ...
    test('get error when  string to page', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .get('/api/campaigns?page="f')
            .expect(400);
        expect(response.body.message).toBe('"page" must be a number');
    }));
    test('get error when limit is string', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .get('/api/campaigns?limit=f')
            .expect(400);
        expect(response.body.message).toBe('"limit" must be a number');
    }));
    test('get campaigns with is not available', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .get('/api/campaigns?available=false')
            .expect(200);
        expect(response.body.data.campaigns).toEqual([]);
    }));
    test('get campaigns with name Summer and category=education', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .get('/api/campaigns?search=summer%20clothes%20collection&category=Education')
            .expect(200);
        expect(response.body.data.campaigns).toEqual([
            {
                id: 3,
    ...
    test('get campaigns with name not exit', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    describe('GET /api/admin/families', () => {
        test('Unauthorized user admin', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app_1.default)
                .get('/api/admin/families')
                .expect(401);
            expect(response.body.message).toEqual('Unauthorized user');
        }));
        test('/?page validation error', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app_1.default)
        ...
        test('first page families', () => __awaiter(void 0, void 0, void 0, function* () {
            const { body: { data: { families, count }, }, } = yield (0, supertest_1.default)(app_1.default)
...
describe('PATCH /api/admin/family', () => {
    test('case: succeeded | updated successfully', () => __awaiter(void 0, void 0, void 0, function* () {
        const id = 1;
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('case: Failed | updated successfully', () => __awaiter(void 0, void 0, void 0, function* () {
        const id = 1;
        const response = yield (0, supertest_1.default)(app_1.default)
            .patch(`/api/admin/family/${id}`)
            .send({
    ...
    test('case: Failed | updated Failed', () => __awaiter(void 0, void 0, void 0, function* () {
        const id = 111;
        const response = yield (0, supertest_1.default)(app_1.default)
            .patch(`/api/admin/family/${id}`)
            .send({
    ...
    test('case: Failed | Unauthorized user', () => __awaiter(void 0, void 0, void 0, function* () {
        const id = 1;
        const response = yield (0, supertest_1.default)(app_1.default)
            .patch(`/api/admin/family/${id}`)
            .send({
...
describe('POST /api/admin/family', () => {
    test('case: succeeded | added successfully', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('case: Failed | phone is used', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .post('/api/admin/family')
            .send({
            name: 'mohammed',
    ...
    test('case: Failed | "address" does not exist', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .post('/api/admin/family')
            .send({
            name: 'mohammed',
...
describe('GET /admin/campaigns?page=<number>', () => {
    test('Get all reports  <Unauthorized user>', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default).get('/api/admin/campaigns').expect(401);
        expect(response.body.message).toEqual('Unauthorized user');
    }));
    test('Get all reports  <Unauthorized admin>', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('Get all reports  <Authorized admin> <page 1>', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('Get all reports  <Authorized admin> <page 2>', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('Get all reports  <Authorized admin> <not valid page>', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
...
describe('GET /admin/reports', () => {
    test('Get all reports  <Unauthorized user>', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default).get('/api/admin/reports').expect(401);
        expect(response.body.message).toEqual('Unauthorized user');
    }));
    test('Get all reports  <Unauthorized admin>', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
...
describe('DELETE /api/admin/family/:id', () => {
    test('Delete family <Unauthorized user>', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .delete('/api/admin/family/1')
            .expect(401);
        expect(response.body.message).toEqual('Unauthorized user');
    }));
    test('Delete family <Unauthorized admin>', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .delete('/api/admin/family/1')
            .set('Cookie', [
    ...
    test('Delete family <Authorized admin> <Family exists>', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .delete('/api/admin/family/1')
            .set('Cookie', [
    ...
    test('Delete family <Authorized admin> <Family exists>', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            ...
            .expect(400);
        expect(response.body.message).toEqual('The family you are trying to delete does not exist');
    }));
    test('Delete family <Authorized admin> <Not valid id param>', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
...
describe('DELETE /api/admin/donor/:donorId', () => {
    test('case: succeeded | Deleted successfully', () => __awaiter(void 0, void 0, void 0, function* () {
        const donorId = 2;
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('case: Failed | id does not exist', () => __awaiter(void 0, void 0, void 0, function* () {
        const donorId = 10;
        const response = yield (0, supertest_1.default)(app_1.default)
            .delete(`/api/admin/donor/${donorId}`)
            .set('Cookie', [
    ...
    test('case: Failed | id is not a number', () => __awaiter(void 0, void 0, void 0, function* () {
        const donorId = 'w';
        const response = yield (0, supertest_1.default)(app_1.default)
            .delete(`/api/admin/donor/${donorId}`)
            .set('Cookie', [
...
describe('GET /api/families/campaigns/:id', () => {
    test('unauthorized admin', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default).get('/api/admin/family/1/campaigns');
        expect(400);
        expect(response.body.message).toBe('Unauthorized user');
    }));
    test('params id must be number', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('family doesnt exist', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('get family campaigns', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
...
describe('/GET/api/admin/donors', () => {
    test('get donors', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('get donors with limit and page', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
...
describe('PATCH /api/admin/donor/:id', () => {
    test('success update donor', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('failed updating donor', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('id must be a number', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('Unauthorized user', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .patch('/api/admin/donor/string')
            .expect(401);
        expect(response.body.message).toBe('Unauthorized user');
...
describe('GET/admin/donor/campaigns/:id', () => {
    test('get campaigns for donor that have id 1', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('get campaings for donor id not exist', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('get campaings for Authorized user', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .get('/api/admin/donor/1/campaigns')
            .set('Cookie', [
            'ACCESS_TOKEN=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwibmFtZSI6IkFobWVkIiwiaXNBZG1pbiI6ZmFsc2UsImlhdCI6MTY1MjExOTI4OSwiZXhwIjoxNjU0NzExMjg5fQ.WNuAaN7EcIrUx7RV2EMj_E46vbRP4FU5e8vsjMcwCpY',
...
describe('POST /api/admin/campaigns', () => {
    ...
    test('missing column categoryId', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .post('/api/admin/campaigns')
            .set('Cookie', [
            'ACCESS_TOKEN=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwibmFtZSI6ImFkbWluIiwiaXNBZG1pbiI6dHJ1ZSwiaWF0IjoxNjUxOTk4NDgzLCJleHAiOjE2NTQ1OTA0ODN9.LBvMMkPbcTeBMbKBeOQ7sYe1s-Wy5zHjhbjjTtcByFw',
    ...
    test('title as number', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .post('/api/admin/campaigns')
            .set('Cookie', [
            'ACCESS_TOKEN=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwibmFtZSI6ImFkbWluIiwiaXNBZG1pbiI6dHJ1ZSwiaWF0IjoxNjUxOTk4NDgzLCJleHAiOjE2NTQ1OTA0ODN9.LBvMMkPbcTeBMbKBeOQ7sYe1s-Wy5zHjhbjjTtcByFw',
    ...
    test('add new campaign', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .post('/api/admin/campaigns')
            .set('Cookie', [
            'ACCESS_TOKEN=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwibmFtZSI6ImFkbWluIiwiaXNBZG1pbiI6dHJ1ZSwiaWF0IjoxNjUxOTk4NDgzLCJleHAiOjE2NTQ1OTA0ODN9.LBvMMkPbcTeBMbKBeOQ7sYe1s-Wy5zHjhbjjTtcByFw',
...
describe('DELETE /api/admin/campaigns/:id', () => {
    test('unauthorized user', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default).delete('/api/admin/campaigns/1');
        expect(401);
        expect(response.body.message).toBe('Unauthorized user');
    }));
    test('campaign id not a number', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('campaign doesnt exist', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('campaign delete success', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
...
describe('DELETE/admin/reports/id', () => {
    test('delete report that exist', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('delete report that does not exist', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
...
describe('PATCH/api/admin/campaign/id', () => {
    test('edit campaign exist', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('edit campaign exist not exist', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
...
describe('GET /admin/campaign/:id/families', () => {
    test('Get all campaigns for specific family  <Unauthorized user>', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .get('/api/admin/campaign/1/families')
            .expect(401);
        expect(response.body.message).toEqual('Unauthorized user');
    }));
    test('Get all campaigns for specific family  <Unauthorized admin>', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .get('/api/admin/campaign/1/families')
            .set('Cookie', [
            'ACCESS_TOKEN=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MiwibmFtZSI6IkFobWVkIiwiaXNBZG1pbiI6ZmFsc2UsImlhdCI6MTY1MTk5OTY3OSwiZXhwIjoxNjU0NTkxNjc5fQ.Z0Tq0XxGNbQ72J4BRAp06Qo6xYq41jb59-5uRK1JfuA',
    ...
    test('Get all campaigns for specific family <Authorized admin> <No families>', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .get('/api/admin/campaign/1/families')
            .set('Cookie', [
            'ACCESS_TOKEN=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwibmFtZSI6ImFkbWluIiwiaXNBZG1pbiI6dHJ1ZSwiaWF0IjoxNjUxOTk4NDgzLCJleHAiOjE2NTQ1OTA0ODN9.LBvMMkPbcTeBMbKBeOQ7sYe1s-Wy5zHjhbjjTtcByFw',
    ...
    test('Get all campaigns for specific family <Authorized admin>', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('Get all campaigns for specific family <Authorized admin> <No Campaign>', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
...
describe('POST api/admin/campagin/:id/families', () => {
    test('case:Fail |campaign id not valid', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .post('/api/admin/campaign/d/families')
            .set('Cookie', [
            'ACCESS_TOKEN=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwibmFtZSI6ImFkbWluIiwiaXNBZG1pbiI6dHJ1ZSwiaWF0IjoxNjUxOTk4NDgzLCJleHAiOjE2NTQ1OTA0ODN9.LBvMMkPbcTeBMbKBeOQ7sYe1s-Wy5zHjhbjjTtcByFw',
        ])
            .send({
    ...
    test('case:Fail |campaign id does not exits ', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test("case:Fail | Campaign doesn't have donations", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('case:Fail | ids array is not an array of numbers', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
    ...
    test('case:Fail |array item not number', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .post('/api/admin/campaign/1/families')
            .set('Cookie', [
            'ACCESS_TOKEN=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwibmFtZSI6ImFkbWluIiwiaXNBZG1pbiI6dHJ1ZSwiaWF0IjoxNjUxOTk4NDgzLCJleHAiOjE2NTQ1OTA0ODN9.LBvMMkPbcTeBMbKBeOQ7sYe1s-Wy5zHjhbjjTtcByFw',
    ...
    test('case:success ', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .post('/api/admin/campaign/1/families')
            .set('Cookie', [
            'ACCESS_TOKEN=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwibmFtZSI6ImFkbWluIiwiaXNBZG1pbiI6dHJ1ZSwiaWF0IjoxNjUxOTk4NDgzLCJleHAiOjE2NTQ1OTA0ODN9.LBvMMkPbcTeBMbKBeOQ7sYe1s-Wy5zHjhbjjTtcByFw',
    ...
    test('case:fail with close git campaign ', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .post('/api/admin/campaign/1/families')
            .set('Cookie', [
            'ACCESS_TOKEN=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwibmFtZSI6ImFkbWluIiwiaXNBZG1pbiI6dHJ1ZSwiaWF0IjoxNjUxOTk4NDgzLCJleHAiOjE2NTQ1OTA0ODN9.LBvMMkPbcTeBMbKBeOQ7sYe1s-Wy5zHjhbjjTtcByFw',
    ...
    test('case:fail families does not exist ', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
